# Scenario NN 
# Dataset: 1-1-17 tm 31-8-19
# Trainset: 1-1-17 tm 30-6-19
...
Dagpax_1719  <- read.csv("DataFiles/Dagpax_1719.csv") # 971 obs
head(Dagpax_1719)
tail(Dagpax_1719)

# Dataset train periode vanaf 1-1-14 tm 30-6-19
Dagpax_17train <- Dagpax_1719 %>% filter(Actuele.datum.tijd >= '2017-01-01' & Actuele.datum.tijd <='2019-06-30') #909 obs
summary(Dagpax_17train)

### Visual ts totaledataset
Dagpax.ts <- ts(Dagpax_17train$PassagiersPerDag, start = c(2017,1), frequency = 365.25)
plot(Dagpax.ts, xlab="Jaren", ylab="Aantal passagiers", main="Aantal passagiers 1-1-2017 t/m 31-8-2019")
...
jul_aug_pax <- as.data.frame(tail(Dagpax_1719, 62)[,2])
#jul_aug_pax
